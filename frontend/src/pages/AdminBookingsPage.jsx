...
export function AdminBookingsPage() {
  ...
  const loadBookings = async () => {
    try {
      setLoading(true);
      const bookings = await bookingApi.allBookings();
    ...
    <div className="px-8 py-8">
      ...
      {loading ? (
        ...
        <div className="text-center py-20">
          ...
          <h3 className="text-lg font-medium text-gray-900 mb-2 tracking-tight">No bookings found</h3>
          <p className="text-gray-500 text-sm font-light">There are no active bookings at the moment</p>
        </div>
      ) : (
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center gap-2 text-gray-600">
                      ...
                      <span className="text-sm font-light">
                        ...
                        <span className="text-gray-900">{booking.user?.email || "Unknown"}</span>
                      </span>
                    </div>
